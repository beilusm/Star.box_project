...
#define MPU6050_I2C_ADDR  0x68<<1 //devAddr
...
void MPU6050_EnableMotionInterrupt();//启用INT运动中断检测引脚

void MPU6050_Read_Accel(MPU6050_t *DataStruct);//读取加速度
void MPU6050_Read_Gyro(MPU6050_t *DataStruct);//读取角速度
void MPU6050_Read_G_A(MPU6050_t *DataStruct);//读取加速度和角速度
void MPU6050_StartDMArx();//以DMA方式接收MPU6050的姿态信息
